...
// src/components/h-stack/h-stack.tsx
...
var Flex = forwardRef2((props, ref) => {
  const [variantProps, otherProps] = createSplitProps()(props, ["inline"]);
  return /* @__PURE__ */ jsx2(Box, __spreadValues({ ref, display: variantProps.inline ? "inline-flex" : "flex" }, otherProps));
});
Flex.displayName = "Flex";

// src/components/h-stack/h-stack.tsx
import { jsx as jsx3 } from "react/jsx-runtime";
var HStack = forwardRef3((_a, ref) => {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  const [hStackProps, otherProps] = createSplitProps()(props, ["reverse"]);
  return /* @__PURE__ */ jsx3(Flex, __spreadProps(__spreadValues({ flexDirection: hStackProps.reverse ? "row-reverse" : "row", ref }, otherProps), { children }));
});
