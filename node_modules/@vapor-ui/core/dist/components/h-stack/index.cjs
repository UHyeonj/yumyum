...
// src/components/h-stack/index.ts
var h_stack_exports = {};
...
var HStack = (0, import_react3.forwardRef)((_a, ref) => {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  const [hStackProps, otherProps] = createSplitProps()(props, ["reverse"]);
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Flex, __spreadProps(__spreadValues({ flexDirection: hStackProps.reverse ? "row-reverse" : "row", ref }, otherProps), { children }));
});
