...
var gridItemColSpan = "var(--grid-item-col-span__1suuv4pd)";
var gridItemRowSpan = "var(--grid-item-row-span__1suuv4pc)";
var gridTemplateColumns = "var(--grid-template-columns__1suuv4p1)";
var gridTemplateRows = "var(--grid-template-rows__1suuv4p0)";
var item = "grid__1suuv4pe";
var root = (0, import_createRuntimeFn2.createRuntimeFn)({ defaultClassName: "grid__1suuv4p7 grid__1suuv4p2", variantClassNames: { flow: { row: "grid__1suuv4p3", column: "grid__1suuv4p4", "row-dense": "grid__1suuv4p5", "column-dense": "grid__1suuv4p6" } }, defaultVariants: { flow: "row" }, compoundVariants: [] });
...
var Root = (0, import_react2.forwardRef)(
  (_a, ref) => {
    ...
    const _a2 = variantProps, { inline, templateRows, templateColumns } = _a2, variants = __objRest(_a2, ["inline", "templateRows", "templateColumns"]);
    const cssVariables = (0, import_dynamic.assignInlineVars)({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      ...
      __spreadProps(__spreadValues({
        ...
        className: (0, import_clsx2.default)(root(variants), className)
      }, otherProps), {
        children
      })
    );
...
var Item = (0, import_react2.forwardRef)(
  (_a, ref) => {
    var _b = _a, { rowSpan, colSpan, className, style, children } = _b, props = __objRest(_b, ["rowSpan", "colSpan", "className", "style", "children"]);
    const cssVariables = (0, import_dynamic.assignInlineVars)({
      [gridItemRowSpan]: rowSpan,
      [gridItemColSpan]: colSpan
    });
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      Box,
      __spreadProps(__spreadValues({
        ref,
        style: __spreadValues(__spreadValues({}, cssVariables), style),
        className: (0, import_clsx2.default)(item, className)
      }, props), {
        children
      })
    );
